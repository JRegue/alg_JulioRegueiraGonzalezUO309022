...
public class AlmacenajeContenedoresListas {
    ...
    public AlmacenajeContenedoresListas(int capacidadC, Integer[] conjuntoS){
    ...
    public static void main(String archivo){
        try {
            ...
            sc.close();
            new AlmacenajeContenedoresListas(capacidadC,toS).resolver();
