            ...
            try {
                ...
                try {
                    ...
                    for (int i = 1; i <= repeticiones; i++) {
                        AlmacenajeContenedoresRyP.llamadas = 0;

                        t1 = System.currentTimeMillis();

                        AlmacenajeContenedoresRyP.main(new String[]{ruta});
                ...
                System.out.println(nombreArchivo + "\t" + t + "\t\t" + repeticiones + "\t\t" + AlmacenajeContenedoresRyP.llamadas);
